...
import { resetUserData } from '../features/auth/UserSlice';
        ...
        <div className='container  mx-auto flex justify-between mt-6  inset-x-0  items-center '>
          ...
          <div className='flex  items-stretch'>
            <Menu/>
            {
              ...
              :
              <button  onClick={() => dispatch(resetUserData())} className='bg-accent font-medium self-center  p-3 px-4 hover:bg-accent-hover  hover:shadow-2xl  hover:shadow-accent rounded-md hover:text-white transition-all	 duration-200   text-sm'>Logout</button>
              }
          </div>
        </div>
